...
function Card({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="rounded-xl p-6" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E8E7E4' }}>
      <h3 className="text-base mb-5" style={{ fontFamily: 'var(--font-barlow-condensed)', fontWeight: 700, color: '#0D0B0A' }}>
        {title}
      </h3>
      {children}
    </div>
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <span className="text-3xl font-bold" style={{ fontFamily: 'var(--font-barlow-condensed)', color: '#FF5500' }}>
        ...
        {data.total === 0 && data.totalGeral > 0 && (
          <span
            ...
            style={{ backgroundColor: '#FEF3C7', color: '#92400E', fontFamily: 'var(--font-barlow)' }}
          >
