        ...
        <table className="w-full text-xs" style={{ minWidth: 580 }}>
          ...
          <tbody>
            {rows.map(r => {
              ...
              const convColor = isBest ? '#15803D' : isWorst ? '#B91C1C' : '#0D0B0A'

              return (
                <tr key={r.canal} style={{ borderBottom: '1px solid #F0EFED', backgroundColor: bg }}>
                  <td className="px-3 py-2.5 font-medium" style={{ color: '#0D0B0A', fontFamily: 'var(--font-barlow)' }}>{r.canal}</td>
                  <td className="px-3 py-2.5 text-center" style={{ color: '#0D0B0A', fontFamily: 'var(--font-barlow)' }}>{r.leads}</td>
                  <td className="px-3 py-2.5 text-center" style={{ color: '#8A8986', fontFamily: 'var(--font-barlow)' }}>{r.contactados}</td>
                  <td className="px-3 py-2.5 text-center" style={{ color: '#8A8986', fontFamily: 'var(--font-barlow)' }}>{r.videos}</td>
                  <td className="px-3 py-2.5 text-center" style={{ color: '#8A8986', fontFamily: 'var(--font-barlow)' }}>{r.aprovados}</td>
                  <td className="px-3 py-2.5 text-center" style={{ color: '#8A8986', fontFamily: 'var(--font-barlow)' }}>{r.contratados}</td>
                  <td className="px-3 py-2.5 text-center font-semibold" style={{ color: convColor, fontFamily: 'var(--font-barlow)' }}>
                    {r.taxa}%
                  </td>
                </tr>
              )
